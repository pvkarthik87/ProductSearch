...
public class AvailableSort implements Parcelable
{
    ...
    @Expose
    private String name;
    public final static Creator<AvailableSort> CREATOR = new Creator<AvailableSort>() {
        ...
        public AvailableSort createFromParcel(Parcel in) {
            AvailableSort instance = new AvailableSort();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AvailableSort) == false) {
            return false;
        }
        AvailableSort rhs = ((AvailableSort) other);
