...
public class PathFromRoot implements Parcelable
{
    ...
    @Expose
    private String name;
    public final static Creator<PathFromRoot> CREATOR = new Creator<PathFromRoot>() {


        @SuppressWarnings({
            "unchecked"
        })
        public PathFromRoot createFromParcel(Parcel in) {
            PathFromRoot instance = new PathFromRoot();
            instance.id = ((String) in.readValue((String.class.getClassLoader())));
            instance.name = ((String) in.readValue((String.class.getClassLoader())));
            return instance;
        }

        public PathFromRoot[] newArray(int size) {
            return (new PathFromRoot[size]);
        }
